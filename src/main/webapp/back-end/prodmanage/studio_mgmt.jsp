...
<link rel="stylesheet" href="${pageContext.request.contextPath}/back-end/prodmanage/css/std_mgmt.css"> 
<link rel="stylesheet" href="${pageContext.request.contextPath}/back-end/prodmanage/css/std_add.css">   
</head>
<%
...
<body>
    ...
    <div class="container">
   	...
   	<%-- 修改錄音室表單 --%>
 	<jsp:include page="/back-end/prodmanage/std_update.jsp"/>
    ...
    <script src="${pageContext.request.contextPath}/back-end/prodmanage/js/std_mgmt.js"></script>
</body>
</html>