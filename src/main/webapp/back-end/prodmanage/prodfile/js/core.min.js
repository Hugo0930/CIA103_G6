...
function pageTransition ( options ) {
  ...
  options.conditions =        options.conditions        || function ( event, link ) {
  ...
  if ( options.target ) {
    ...
    $('a').click( function( event ) {
      ...
      if ( options.conditions( event, link ) ) {
        ...
        setTimeout( function () {
          ...
          // bug with empty page when use back/forward button in firefox
          ...
          // bug with empty page when use back/forward button in safari
