...
<table id="table-1">
	<tr><td>	
		 <h3>所有廣告資料 </h3>
		 <h4>
		 <a href="${pageContext.request.contextPath}/back-end/advertisement/select_page.jsp"><img src="<%=request.getContextPath()%>/back-end/advertisement/images/back1.gif"  width="100" height="32" border="0">回首頁</a>
		 </h4>
	</td></tr>
</table>
...
<table>
	...
	<c:forEach var="advertisementVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/advertisement.do" style= "margin-bottom: 0px;">
