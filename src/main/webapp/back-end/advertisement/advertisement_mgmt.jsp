...
<link rel="stylesheet" href="${pageContext.request.contextPath}/back-end/advertisement/css/studio_manage.css">  
</head>
...
<body>
    ...
    <!-- 現在位置 -->
    <div class="container">
        <h2><i class="fa-solid fa-house"></i>廣告管理</h2>
        <hr>
<!--         <div id="lookup_block"> -->
...
<!-- 	        </select> -->
<!--         </div> -->
        <button type="submit"  id="btn_add"><i class="fa-solid fa-plus"></i>新增廣告</button>
<%--         <h3>總共${pageQty}頁，現在第${currentPage}頁</h3> --%>
	   	<table>
	     	<thead>
	     		<tr>
		        	<th scope="col" id="id">廣告編號</th>
		        	<th scope="col" id="img">管理員編號</th>
		        	<th scope="col" id="loc">標題</th>
		        	<th scope="col" id="name">詳細內容</th>
		        	<th scope="col" id="capacity">圖片路徑</th>
		        	<th scope="col" id="rent">跳轉路徑</th>
		            <th scope="col" id="rent">開始日期</th>
		            <th scope="col" id="rent">結束日期</th>
