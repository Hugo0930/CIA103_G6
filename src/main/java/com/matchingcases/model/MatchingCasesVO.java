...
public class MatchingCasesVO implements java.io.Serializable {
	...
	public MatchingCasesVO(Integer caseId, Integer memId, Integer receiverId, String title, String description,
			BigDecimal budget, Date startDate, Date endDate, Integer status, Date createdAt, Integer caseTot) {
		super();
		this.caseId = caseId;
		this.memId = memId;
	...
	public Integer getCaseTot() {
		return caseTot;
	}


	public void setCaseTot(Integer caseTot) {
		this.caseTot = caseTot;
	}
